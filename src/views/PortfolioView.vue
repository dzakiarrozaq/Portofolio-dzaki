  ...
  <div class="px-5 py-5 md:px-12 md:py-10 text-left text-amber-50 mx-3">
    <article data-page="about">
      ...
      <section>
        <div>
          <div
            class="grid grid-cols-1 gap-4 pb-32 md:grid-cols-3 md:gap-3 xl:grid-cols-3 xl:gap-3 2xl:gap-5 fade-zoom-in items-stretch">
            
            <div v-for="item in items" :key="item.id" class="flex">
              <div
                class="item-card flex flex-col items-center gap-2 rounded bg-[#1e1e1f] hover:bg-[#282828] border border-[#383838] rounded-xl text-amber-50 md:gap-3 px-5 py-5 lg:px-5 h-full w-full">
                
                <!-- Gambar -->
                <div class="flex items-center justify-center w-full">
                  <img alt="Project Image" loading="lazy" decoding="async"
                    class="drop-shadow-xl rounded rounded-xl object-cover w-full h-40"
